...
our $SCHEMA = [
    ...
    #          COMMAND                 LABEL                ICON
    {item => ["$terminal --columns=130 --rows=45 -e sudo /opt/archbox/install.sh", 'Install Archbox', 'system-run']},
    {item => ['pcmanfm',        'File manager',      'folder']},
    ...
    {begin_cat => ['Advanced settings', 'gnome-settings']},
        ...
        {begin_cat => ['Openbox', 'openbox']},
            ...
            {item => ['obkey',  'Openbox Keyboard shortcuts', 'openbox']},
        {end_cat => undef},
